...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ...
    `
        ...
        const variants = {
            default:
                "bg-slate-800 border-slate-600 text-slate-100 hover:border-cyan-400 hover:text-cyan-300 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)]",
            primary:
                "bg-gradient-to-r from-blue-600 to-cyan-600 border-cyan-400 text-white hover:from-blue-700 hover:to-cyan-700 hover:shadow-[0_0_25px_rgba(6,182,212,0.5)]",
            secondary:
                "bg-gradient-to-r from-purple-600 to-pink-600 border-purple-400 text-white hover:from-purple-700 hover:to-pink-700 hover:shadow-[0_0_25px_rgba(168,85,247,0.5)]",
